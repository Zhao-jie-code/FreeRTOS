...
static QueueHandle_t g_xQueueMU6050;

QueueHandle_t GetQueueMPU6050(void)
{
    return g_xQueueMU6050;
}
...
int MPU6050_Init(void)
{
    ...
    g_xQueueMU6050 = xQueueCreate( 10, sizeof(struct mpu6050_data));
...
void MPU6050_Task(void *params)
{
    ...
    {    
        ...
        {
            /* 解析数据 */
            MPU6050_ParseData(AccX, 0, 0, 0, 0, 0, &GetX);
            /* 写队列 */
            xQueueSend(g_xQueueMU6050, &GetX, 0);
        }
		vTaskDelay(50);
	}
