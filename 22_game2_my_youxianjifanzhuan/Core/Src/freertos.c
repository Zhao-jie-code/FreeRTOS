...
static SemaphoreHandle_t  g_xSemI2C;
...
{
    /* µ»¥˝I2Cª•≥‚¡ø */
    xSemaphoreTake(g_xSemI2C, portMAX_DELAY);
}   

void ReleaseI2C(void)
{
    /* Õ∑≈I2Cª•≥‚¡ø*/
    xSemaphoreGive(g_xSemI2C);
...
void MX_FREERTOS_Init(void) {
  ...
  g_xSemI2C = xSemaphoreCreateMutex();
...
//			  else
//			  {
//				  /* Ë¶Å‰πàsuspendË¶Å‰πàresume */
//				  if (bRunning)
//				  {
//					  LCD_ClearLine(0, 0);
//					  LCD_PrintString(0, 0, "Suspend Task");
//					  vTaskSuspend(xSoundTaskHandle);
//					  PassiveBuzzer_Control(0); /* ÂÅúÊ≠¢ËúÇÈ∏£Âô? */
//					  bRunning = 0;
//				  }
//				  else
//				  {
