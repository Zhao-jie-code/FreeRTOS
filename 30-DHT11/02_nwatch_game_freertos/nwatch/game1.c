...
static TimerHandle_t g_TimerDHT11;/*定时器*/
...
/**/
static void Game1DHT11Timer_Function( TimerHandle_t xTimer )
{
    int hum;
    int temp;
    int err;
...
{		    
    ...
    DHT11_Init();
    /*创建定时器*/
    g_TimerDHT11 = xTimerCreate( "Game1DHT11", 
							2000,
							pdTRUE,
							NULL,
							Game1DHT11Timer_Function);
	/*启动定时器*/
