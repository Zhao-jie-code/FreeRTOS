...
static StackType_t g_pucStackOfColorTask[80];
...
//	car_game();
  ...
  /* 创建任务:�? */
  xColorTaskHandle = xTaskCreateStatic(ColorLED_Test, "ColorTask", 80, NULL, osPriorityNormal, g_pucStackOfColorTask, &g_TCBofColorTask);
